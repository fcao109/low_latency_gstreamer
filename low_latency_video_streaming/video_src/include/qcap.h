...
enum {
	...
	QCAP_COLORSPACE_TYPE_YV24	= 0x34325659, // 0x34325659 -> MAKEFOURCC('Y', 'V', '2', '4') (4:4:4 | 08 BITS) (Y V U)
	...
	QCAP_COLORSPACE_TYPE_AV01	= 0x31305641, // 0x31305641 -> MAKEFOURCC('A', 'V', '0', '1')
...
enum {
	...
	QCAP_PTZ_CMD_EXPOSURE_AUTO			= 0x0000000E, // PUT THE CAMERA IN AUTO-EXPOSURE MODE                                      | P1: 
													  //												                           | P2: 
	QCAP_PTZ_CMD_EXPOSURE_MANUAL		= 0x0000000F, // MANUALLY SET THE CAMERA EXPOSURE                                          | P1: IRIS = 0.0 (DARK) ... 1.0 (LIGHT)
													  //												                           | P2: GAIN = 0.0 (DARK) ... 1.0 (LIGHT)
													  //												                           | P3: SHUTTER_SPEED = 0.0 (SLOW) ... 1.0 (FAST)
...
//
// Historical naming: this family acquires/releases a device preview buffer. It
// is unrelated to QCAP_RCBUFFER_LOCK_DATA/UNLOCK_DATA, does not identify a
// 0xFFFFCAFE tagged RC wrapper, and must not be used as an RC lifetime pin.
// These legacy declarations are retained for compatibility; verify symbol and
// backend availability for the selected SDK/platform before use.
//
...
QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_BACKLIGHTCOMP( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/, BOOL * pAuto /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_BACKLIGHTCOMP( PVOID pDevice /*IN*/, LONG nValue /*IN*/, BOOL bAuto /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_EXPOSURE( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/, BOOL * pAuto /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_EXPOSURE( PVOID pDevice /*IN*/, LONG nValue /*IN*/, BOOL bAuto /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_FOCUS( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/, BOOL * pAuto /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_FOCUS( PVOID pDevice /*IN*/, LONG nValue /*IN*/, BOOL bAuto /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_FOV( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/ ); // [CV830W: 0:110 1:96 2:84]

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_FOV( PVOID pDevice /*IN*/, LONG nValue /*IN*/ ); // [CV830W: 0:110 1:96 2:84]

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_GAIN( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/, BOOL * pAuto /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_GAIN( PVOID pDevice /*IN*/, LONG nValue /*IN*/, BOOL bAuto /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_GAMMA( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/, BOOL * pAuto /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_GAMMA( PVOID pDevice /*IN*/, LONG nValue /*IN*/, BOOL bAuto /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_POWERLINE_FREQUENCY( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/ ); // 0: DISABLE / 1: 50HZ / 2: 60HZ

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_POWERLINE_FREQUENCY( PVOID pDevice /*IN*/, LONG nValue /*IN*/ ); // 0: DISABLE / 1: 50HZ / 2: 60HZ

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_WHITE_BALANCE( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/, BOOL * pAuto /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_WHITE_BALANCE( PVOID pDevice /*IN*/, LONG nValue /*IN*/, BOOL bAuto /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_ZOOM( PVOID pDevice /*IN*/, LONG * pValue /*OUT*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_SET_CAMERA_ZOOM( PVOID pDevice /*IN*/, LONG nValue /*IN*/ );

QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_CAMERA_CONTROL_PROPERTY_RANGE_EX( PVOID pDevice /*IN*/, ULONG nProperty /*IN*/, LONG * pValue_Min /*OUT*/, LONG * pValue_Max /*OUT*/, LONG * pValue_Default /*OUT*/ );
...
QCAP_EXT_API QRESULT QCAP_EXPORT /*|    |    |  |    |NDI|2D|  |*/ QCAP_CREATE_BROADCAST_NDI_CLIENT( UINT iCliNum /*IN*/ /*0 ~ 63*/, CHAR * pszNDIName /*IN*/, CHAR * pszGroupName /*IN*/, PVOID * ppClient /*OUT*/, BOOL bEnableNDIProxy DEFVAL( FALSE /*IN*/), ULONG nDecoderType DEFVAL( QCAP_DECODER_TYPE_SOFTWARE /*IN*/), HWND hAttachedWindow DEFVAL( NULL /*IN*/), BOOL bThumbDraw DEFVAL( FALSE /*IN*/), BOOL bMaintainAspectRatio DEFVAL( FALSE /*IN*/ ));

QCAP_EXT_API QRESULT QCAP_EXPORT /*|    |    |  |    |NDI|2D|  |*/ QCAP_CREATE_BROADCAST_NDI_HX_CLIENT( UINT iCliNum /*IN*/ /*0 ~ 63*/, CHAR * pszNDIName /*IN*/, CHAR * pszGroupName /*IN*/, PVOID * ppClient /*OUT*/, BOOL bEnableNDIProxy DEFVAL( FALSE /*IN*/), ULONG nDecoderType DEFVAL( QCAP_DECODER_TYPE_SOFTWARE /*IN*/), HWND hAttachedWindow DEFVAL( NULL /*IN*/), BOOL bThumbDraw DEFVAL( FALSE /*IN*/), BOOL bMaintainAspectRatio DEFVAL( FALSE /*IN*/ ));
...
QCAP_EXT_API QRESULT QCAP_EXPORT /*|RTSP|    |  |    |   |2D|3D|*/ QCAP_GET_BROADCAST_CLIENT_PELCO_CONNECTION( PVOID pClient /*IN*/, UINT iSessionNum /*IN*/, BYTE * pDevAddr /*OUT*/, ULONG * pComPort /*OUT*/, ULONG * pBaudRate DEFVAL( NULL /*OUT*/), ULONG * pDataBits DEFVAL( NULL /*OUT*/), ULONG * pParityCheck DEFVAL( NULL /*OUT*/), ULONG * pStopBits DEFVAL( NULL /*OUT*/), ULONG * pFlowControl DEFVAL( NULL /*OUT*/), BOOL * pAsynchronousIO DEFVAL( NULL /*OUT*/ ));

QCAP_EXT_API QRESULT QCAP_EXPORT /*|RTSP|    |  |    |   |2D|3D|*/ QCAP_SET_BROADCAST_CLIENT_PELCO_CONNECTION( PVOID pClient /*IN*/, UINT iSessionNum /*IN*/, BYTE bDevAddr /*IN*/, ULONG nComPort /*IN*/, ULONG nBaudRate DEFVAL( 9600 /*IN*/), ULONG nDataBits DEFVAL( 8 /*IN*/), ULONG nParityCheck DEFVAL( QCAP_SERIAL_PORT_PARITY_CHECK_NONE /*IN*/), ULONG nStopBits DEFVAL( QCAP_SERIAL_PORT_STOP_BITS_ONE /*IN*/), ULONG nFlowControl DEFVAL( QCAP_SERIAL_PORT_FLOW_CONTROL_NONE /*IN*/), BOOL bAsynchronousIO DEFVAL( TRUE /*IN*/ ));
...
QCAP_EXT_API QRESULT QCAP_EXPORT /*|RTSP|RTMP|TS|MPTS|NDI|2D|3D|*/ QCAP_START_BROADCAST_CLIENT_CLONE_RECORD( PVOID pClient /*IN*/, UINT iSessionNum /*IN*/, CHAR * pszFilePathNameA /*IN*/, CHAR * pszFilePathNameB /*IN*/, double dVideoDelayTime DEFVAL( 0.0 /*IN*/), double dAudioDelayTime DEFVAL( 0.0 /*IN*/), double dSegmentDurationTime DEFVAL( 0.0 /*IN*/), ULONG nSegmentDurationSizeKB DEFVAL( 0 /*IN*/), BOOL bIsSaveMetadata DEFVAL( FALSE /*IN*/), BOOL bIsSubtitle DEFVAL( FALSE /*IN*/), CHAR * pszEncryptKey DEFVAL( NULL /*IN*/ ));

QCAP_EXT_API QRESULT QCAP_EXPORT /*|RTSP|RTMP|TS|MPTS|NDI|2D|3D|*/ QCAP_START_BROADCAST_CLIENT_TIMESHIFT_RECORD( PVOID pClient /*IN*/, UINT iSessionNum /*IN*/, CHAR * pszFilePathName /*IN*/, PVOID * ppPhysicalFileWriter /*OUT*/, double dVideoDelayTime DEFVAL( 0.0 /*IN*/), double dAudioDelayTime DEFVAL( 0.0 /*IN*/), BOOL bIsSaveMetadata DEFVAL( FALSE /*IN*/), BOOL bIsSubtitle DEFVAL( FALSE /*IN*/), CHAR * pszEncryptKey DEFVAL( NULL /*IN*/ ));
...
QCAP_EXT_API QRESULT QCAP_EXPORT /*|    |    |  |    |NDI|2D|  |*/ QCAP_SET_BROADCAST_CLIENT_PTZ_COMMAND( PVOID pClient /*IN*/, UINT iSessionNum /*IN*/, ULONG nCommand /*IN*/, double dParam1 DEFVAL( 0.0 /*IN*/), double dParam2 DEFVAL( 0.0 /*IN*/), double dParam3 DEFVAL( 0.0 /*IN*/ ));
...
// ##########################################################################################################################################################################################
//
typedef QRETURN (QCAP_EXPORT *PF_DICOM_QUERY_RESULT_CALLBACK_100)( PVOID pStation /*IN*/, CHAR * pszResultData /*IN*/, ULONG nResultDataSize /*IN*/, PVOID pUserData /*IN*/ );

typedef QRETURN (QCAP_EXPORT *PF_DICOM_QUERY_RESULT_CALLBACK_192)( PVOID pStation /*IN*/, WSTRING pwszResultData /*IN*/, ULONG nResultDataSize /*IN*/, PVOID pUserData /*IN*/ );

typedef QRETURN (QCAP_EXPORT *PF_DICOM_DOWNLOAD_STATUS_CALLBACK)( PVOID pStation /*IN*/, ULONG nTotalFiles /*IN*/, UINT iCurFileNum /*IN*/, CHAR * pszCurFilePathName /*IN*/, ULONG nCurFileSize /*IN*/, double dDownloadProgress /*IN*/, QRESULT nStatus /*IN*/, PVOID pUserData /*IN*/ );

typedef QRETURN (QCAP_EXPORT *PF_DICOM_UPLOAD_STATUS_CALLBACK)( PVOID pStation /*IN*/, ULONG nTotalFiles /*IN*/, UINT iCurFileNum /*IN*/, CHAR * pszCurFilePathName /*IN*/, ULONG nCurFileSize /*IN*/, double dUploadProgress /*IN*/, QRESULT nStatus /*IN*/, PVOID pUserData /*IN*/ );
...
// ##########################################################################################################################################################################################
// #
// # DICOM FUNCTIONS (WORKLIST CONNECTION <-> WORKLIST SERVER) (100 = ISO_IR 100, 192 = ISO_IR 192)
// #
// ##########################################################################################################################################################################################
//
typedef QRETURN (QCAP_EXPORT *PF_DICOM_WORKLIST_QUERY_RESULT_CALLBACK_100)( PVOID pConnect /*IN*/, CHAR * pszResultData /*IN*/, ULONG nResultDataSize /*IN*/, PVOID pUserData /*IN*/ );

typedef QRETURN (QCAP_EXPORT *PF_DICOM_WORKLIST_QUERY_RESULT_CALLBACK_192)( PVOID pConnect /*IN*/, WSTRING pwszResultData /*IN*/, ULONG nResultDataSize /*IN*/, PVOID pUserData /*IN*/ );
...
// UPLOAD PATIENT REPORT EXAMPLE:
//
// STEP#01 QCAP_START_HL7_UPLOAD_PATIENT_REPORT_OPERATION( pConnect );
//
// STEP#02 QCAP_SEND_HL7_UPLOAD_PATIENT_REPORT_DATA( pConnect, "field name 0", "test report content 0" );
//
//         QCAP_SEND_HL7_UPLOAD_PATIENT_REPORT_DATA( pConnect, "field name 1", "test report content 1" );
// 
//         QCAP_SEND_HL7_UPLOAD_PATIENT_REPORT_DATA( pConnect, "field name 2", "test report content 2" );
//
//         QCAP_SEND_HL7_UPLOAD_PATIENT_REPORT_DATA( pConnect, "field name 3", "test report content 3" );
//
// STEP#03 QCAP_STOP_HL7_UPLOAD_PATIENT_REPORT_OPERATION( pConnect );
...
// When both destination-stream arguments are supplied and *pDstStreamBufferLen is nonzero,
// pDstStreamBufferLen is IN capacity and OUT encoded-stream byte count; caller capacity must
// be sufficient. Keep both caller objects valid until synchronous return or asynchronous
// completion; NULL/zero selects an internal temporary stream buffer instead.
